...
html_message = \
    ...
    Hi! You have a new message in IDR, please check it!
...
def add_email_template(apps, schema_editor):
    ...
    obj, _ = NotificationTemplate.objects.get_or_create(event=NotificationModel.NEW_MESSAGE)
...
class Migration(migrations.Migration):
    dependencies = [
        ('notifications', '0007_auto_20180712_0925'),
    ]
